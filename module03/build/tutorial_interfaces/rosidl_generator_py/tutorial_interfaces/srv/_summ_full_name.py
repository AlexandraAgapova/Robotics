...
class SummFullName_Event(metaclass=Metaclass_SummFullName_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<tutorial_interfaces/SummFullName_Request, 1>',
        'response': 'sequence<tutorial_interfaces/SummFullName_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['tutorial_interfaces', 'srv'], 'SummFullName_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['tutorial_interfaces', 'srv'], 'SummFullName_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from tutorial_interfaces.srv import SummFullName_Request
    ...
    def response(self, value):
        if self._check_fields:
            from tutorial_interfaces.srv import SummFullName_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_SummFullName(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'tutorial_interfaces.srv.SummFullName')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from tutorial_interfaces.srv import _summ_full_name
...
class SummFullName(metaclass=Metaclass_SummFullName):
    from tutorial_interfaces.srv._summ_full_name import SummFullName_Request as Request
    from tutorial_interfaces.srv._summ_full_name import SummFullName_Response as Response
    from tutorial_interfaces.srv._summ_full_name import SummFullName_Event as Event
